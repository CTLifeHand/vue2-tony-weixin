	...
	<section class="dialogue">
		...
		<div class="dialogue_con">
			...
			<section class="conversation">
				<ul>
					<router-link to="/singlechat" tag="li" v-for="(item, index) in dialogueList" :key="index" @click.native="refreshInfor(item)">
						<div class="imgwipe">
...
import { mapState, mapMutations } from 'vuex' // mapActions
